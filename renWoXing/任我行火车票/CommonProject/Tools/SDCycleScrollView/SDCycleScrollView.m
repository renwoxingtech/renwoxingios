...
- (void)initialization
{
    ...
    _titleLabelBackgroundColor = [UIColor colorWithRed:1.0 green:1.0 blue:1.0 alpha:1.0];
    ...
    self.placeholderImage = [UIImage imageNamed:@"placeH"];
...
- (void)setupPageControl
{
    ...
    switch (self.pageControlStyle) {
        ...
        case SDCycleScrollViewPageContolStyleClassic:
        {
            ...
            pageControl.pageIndicatorTintColor = [[UIColor whiteColor] colorWithAlphaComponent:0.6];
