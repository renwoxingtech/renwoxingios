...
//    [_msgLable sizeToFit];
//
////    _msgLable.width = _msgLable.width+30;
////    _msgLable.height = _msgLable.height + 20;
//
//
//    _lableLayer.frame = CGRectMake( _msgLable.left,  _msgLable.top,  _msgLable.width+15,  _msgLable.height+15);
//
...
- (void)createMessageView {
...

    {
        ...
        UIImageView *imageView = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, 80, 80)];
        //转圈圈
        //[UIImage imageNamed:@"myCline"]
        imageView.image        = [UIImage imageNamed:@"myCline"];
        imageView.center       = rotateView.center;
        [rotateView addSubview:imageView];
    }
//[UIImage imageNamed:@"wordLoading"]
    UIImageView *inImageView = [[UIImageView alloc] initWithImage:nil];
    inImageView.scale        = 0.3f;
    [self.messageView addSubview:inImageView];
    inImageView.center = CGPointMake(self.messageView.bounds.size.width*0.5, self.messageView.bounds.size.height*0.5);
...
-(void)updateLable:(NSString *)msg{
    ...
    _lableLayer.center = CGPointMake(50, 50);
//    CGPointMake(MAX(self.width*0.5, 0), self.height*0.5);
    _msgLable.center = _lableLayer.center ;
//    CGPointMake(_lableLayer.width*0.5, _lableLayer.height*0.5);
    [self addSubview:_lableLayer];
    [self addSubview:_msgLable];
//_lableLayer.center = CGPointMake(self.width*0.5, self.height*0.5);
}
